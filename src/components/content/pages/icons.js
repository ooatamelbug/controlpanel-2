...
export default class Formsd extends Component {
 ...
 <div className="content-wrapper">
   ...
   <div className="row icons-list">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-account-location"></i> mdi mdi-account-location
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-account-settings-variant"></i> mdi mdi-account-settings-variant
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-account-star"></i> mdi mdi-account-star
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-account-star-variant"></i> mdi mdi-account-star-variant
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-amazon-clouddrive"></i> mdi mdi-amazon-clouddrive
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-apple-mobileme "></i> mdi mdi-apple-mobileme
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-appnet"></i> mdi mdi-appnet
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-arrow-compress"></i> mdi mdi-arrow-compress
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-arrow-compress-all"></i> mdi mdi-arrow-compress-all
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-book-multiple-variant"></i> mdi mdi-book-multiple-variant
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-burst-mode"></i> mdi mdi-burst-mode
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-chart-scatterplot-hexbin"></i> mdi mdi-chart-scatterplot-hexbin
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-cloud-outline-off"></i> mdi mdi-cloud-outline-off
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-disk"></i> mdi mdi-disk
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-disk-alert"></i> mdi mdi-disk-alert
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-email-secure"></i> mdi mdi-email-secure
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-flag-outline-variant"></i> mdi mdi-flag-outline-variant
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-format-list-numbers"></i> mdi mdi-format-list-numbers
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-fridge-filled"></i> mdi mdi-fridge-filled
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-fridge-filled-bottom"></i> mdi mdi-fridge-filled-bottom
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-fridge-filled-top"></i> mdi mdi-fridge-filled-top
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-hangouts"></i> mdi mdi-hangouts
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-martini"></i> mdi mdi-martini
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-nest-protect"></i> mdi mdi-nest-protect
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-nest-thermostat"></i> mdi mdi-nest-thermostat
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-outbox"></i> mdi mdi-outbox
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-phone-locked"></i> mdi mdi-phone-locked
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-rdio"></i> mdi mdi-rdio
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-stackexchange"></i> mdi mdi-stackexchange
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-stackoverflow"></i> mdi mdi-stackoverflow
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-tooltip-outline-plus"></i> mdi mdi-tooltip-outline-plus
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-unfold-less"></i> mdi mdi-unfold-less
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-unfold-more"></i> mdi mdi-unfold-more
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-verified"></i> mdi mdi-verified
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-vine"></i> mdi mdi-vine
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-violin"></i> mdi mdi-violin
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-visualstudio"></i> mdi mdi-visualstudio
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-weather-partlycloudy"></i> mdi mdi-weather-partlycloudy
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
     ...
     <div className="col-sm-6 col-md-4 col-lg-3">
         <i className="mdi mdi-youtube-play"></i> mdi mdi-youtube-play
     </div>
     <div className="col-sm-6 col-md-4 col-lg-3">
