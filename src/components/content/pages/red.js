            ...
            <div className="col-12 grid-margin stretch-card">
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-description">Add class <code>.btn-gradient-</code> for gradient buttons</p>
                ...
                <div className="card-body">
                  ...
                  <p className="card-description">Add class <code>.btn-outline-</code> for outline buttons</p>
                  <div className="template-demo">
                ...
                <div className="card-body">
                  ...
                  <p className="card-description">Add class <code>.btn</code> for buttons in theme colors</p>
                  <div className="template-demo">
                ...
                <div className="card-body">
                  ...
                  <p className="card-description">Add class <code>.btn-inverse- for inverse buttons</code></p>
                  <div className="template-demo">
                ...
                <div className="card-body">
                  <div className="row">
                    ...
                    <div className="col-md-5">
                      ...
                      <p className="card-description">Use class <code>.btn-</code></p>
                      <div className="template-demo">
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <div className="template-demo">
                    ...
                    <button type="button" className="btn btn-social-icon btn-outline-youtube"><i className="mdi mdi-youtube-play"></i></button>
                  ...
                  <div className="template-demo">
                    ...
                    <button type="button" className="btn btn-social-icon btn-youtube"><i className="mdi mdi-youtube-play"></i></button>
                  ...
                  <div className="template-demo">
                    ...
                    <button type="button" className="btn btn-social-icon btn-youtube btn-rounded"><i className="mdi mdi-youtube-play"></i></button>
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <div className="template-demo">
                    ...
                    <button type="button" className="btn btn-social-icon-text btn-youtube"><i className="mdi mdi-youtube-play"></i>Youtube</button>
